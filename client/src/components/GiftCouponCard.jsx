      ...
      <div className="space-y-4">
        <div className="">
          <label htmlFor="voucher" className="mb-2 block text-sm font-medium text-gray-300">
            Do you have a voucher or gift card code?
          </label>
          <input type="text"
            id="voucher"
            className="block w-full rounded-lg border border-gray-600 bg-gray-700 p-2.5 text-sm text-white placeholder-gray-300 focus:border-emerald-500 focus:outline-none  focus:ring-emerald-500"
